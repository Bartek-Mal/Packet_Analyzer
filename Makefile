...
qmake_all: sub-MultiTool-qmake_all sub-PacketSniffer-qmake_all FORCE

make_first: sub-MultiTool-make_first-ordered sub-PacketSniffer-make_first-ordered  FORCE
all: sub-MultiTool-all-ordered sub-PacketSniffer-all-ordered  FORCE
clean: sub-MultiTool-clean-ordered sub-PacketSniffer-clean-ordered  FORCE
distclean: sub-MultiTool-distclean-ordered sub-PacketSniffer-distclean-ordered  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-MultiTool-install_subtargets-ordered sub-PacketSniffer-install_subtargets-ordered FORCE
uninstall_subtargets: sub-MultiTool-uninstall_subtargets-ordered sub-PacketSniffer-uninstall_subtargets-ordered FORCE
...
check: sub-MultiTool-check_ordered sub-PacketSniffer-check_ordered
...
benchmark: sub-MultiTool-benchmark_ordered sub-PacketSniffer-benchmark_ordered
...
distdir: sub-MultiTool-distdir sub-PacketSniffer-distdir FORCE
